...
Burada küçük ama önemli bir ayrım var: Benim anlattığım saha deneyimi kullandığım eski Lightent 2’ye ait. Güncel ürün listelerinde model, **Lightent 2 Pro** adıyla geçebiliyor. Aşağıdaki teknik değerleri [Alpinetrek’teki güncel Lightent 2 Pro ürün bilgilerinden](https://www.alpinetrek.co.uk/ferrino-lightent-2-pro-2-person-tent/) aldım; eski model deneyimimi yeni modelin her ayrıntısı için doğrudan kanıt gibi düşünmeyin.

| Özellik | Güncel ürün bilgisi |
|---|---|
| Kişi kapasitesi | 2 kişi |
| Çadır tipi | Tünel |
| Kullanım mevsimi | 3 mevsim |
| Paket ağırlığı | 2.100 gram |
| Dış ölçüler | 225 × 120+50 × 100 cm |
| Giriş ve bagaj | 1 giriş, 1 bagaj bölümü |
| Dış kumaş | %100 polyester, PU kaplamalı |
| Dış kumaş su basıncı | 3.000 mm |
| Taban su basıncı | 8.000 mm |
| Kendi kendine ayakta durma | Hayır |
| Ekler | Taşıma çantası, tamir kiti, entegre sineklik |

225 × 120+50 × 100 santimetrelik ölçüdeki `+50`, giriş tarafındaki bagaj bölümünü ifade ediyor. Bu alanın küçük görünmesine aldanmayın; çamurlu botları, ayakkabıları ve su şişesini uyku bölümünden uzak tutmak için oldukça işe yarıyor.

Güncel listede paket ölçüsü ayrıca verilmediği için burada katalogdan uydurma bir hacim hesabı yapmayacağım. Benim kullandığım çadırın en güçlü taraflarından biri, yaklaşık 2 kilogramlık ağırlığının yanında az yer kaplamasıydı.
...
Ben tek başıma kullandığımda alanı daha rahat buluyorum. Çantamı içeri alabiliyor, kıyafetlerimi ve küçük ekipmanları ayak tarafına yerleştirebiliyorum. İki kişi kaldığımızda ise eşyaları düzenli yerleştirmek gerekiyor. Çantalar ve botlar için asıl rahatlık bagaj bölümünden geliyor.
...
![Yeşil alanda, ormanlık yamaçların önünde kurulmuş kırmızı Ferrino Lightent 2 çadırı](ferrino-light-tent-2-kamp-cadiri.jpg "Ferrino Lightent 2 kamp çadırı")

*İki kişilik çadır, tek kişi kullanıldığında ekipman için de nefes alacak alan bırakıyor.*
