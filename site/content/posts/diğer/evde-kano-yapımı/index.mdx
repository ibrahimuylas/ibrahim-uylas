---
title: "Evde Kano Yapımı: Plankton'un Adım Adım Hikâyesi"
slug: evde-kano-yapimi
...
---
Bu yazı, 2013'te bir apartman terasında başlayıp Temmuz 2014'te denize ulaşan ev yapımı Wa'apa Ama kanomuz Plankton'un fotoğraflı yapım hikâyesidir.

> **Güvenlik notu:** Bu içerik teknik bir üretim projesi veya güncel malzeme standardı değildir. Deniz taşıtı yapımı; taşıma kapasitesi, bağlantılar, su yalıtımı ve seyir güvenliği için uzmanlık gerektirir. Benzer bir projeye başlamadan önce güncel planları ve bir uzmanın görüşünü kullanın.

## Hızlı özet

- **Model:** Çift kişilik Wa'apa Ama kano
- **Başlangıç:** Mayıs 2013
- **Suya iniş:** Temmuz 2014
- **Temel malzemeler:** Marin kontrplak, iroko çıtalar, epoksi ve polyester örtü
- **Bu yazının kapsamı:** Teknik ölçülerden çok, modelden test sürüşüne kadar yaşadığımız sürecin fotoğraflı anlatımı
